                                    ...
                                    {{-- <div class="pt-3 border-top border-top-dashed mt-4">
                                        <div class="row">
                                            <div class="col-lg-3 col-sm-6">
                                                <div>
                                                    <p class="mb-2 text-uppercase fw-medium">Tanggal Pembuatan :</p>
                                                    <h5 class="fs-15 mb-0">{{ date('d F Y',
                                                        strtotime($data->created_at)) }}</h5>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-sm-6">
                                                <div>
                                                    ...
                                                    <h5 class="fs-15 mb-0">{{ date('d F Y',
                                                        strtotime($data->tenggat_waktu)) }}</h5>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-sm-6">
                                                <div>
                                                    ...
                                                    <div>
                                                        @if ($data->prioritas == 'Rendah')
                                                        <span class="badge bg-info fs-12">Sedang</span>
                                                        @elseif ($data->prioritas == 'Sedang')
                                                        <span class="badge bg-warning fs-12">Sedang</span>
                                                        @elseif ($data->prioritas == 'Tinggi')
                                                        <span class="badge bg-danger fs-12">Tinggi</span>
                                                        @endif<h5>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-sm-6">
                                                <div>
                                                    <p class="mb-2 text-uppercase fw-medium">Status Tugas :</p>
                                                    <div>
                                                        @if ($data->status_projek == 'Baru')
                                                        <span class="badge bg-secondary fs-12">Baru</span>
                                                        @elseif ($data->status_projek == 'Dalam Proses')
                                                        <span class="badge bg-warning fs-12">Dalam
                                                            Proses</span>
                                                        @elseif ($data->status_projek == 'Tertunda')
                                                        <span class="badge bg-danger fs-12">Tertunda</span>
                                                        @elseif ($data->status_projek == 'Selesai')
                                                        <span class="badge bg-success fs-12">Selesai</span>
                                                        @endif<h5>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1 overflow-hidden">
                                                            <h5 class="fs-13 mb-1"><a
                                                                    href="{{ asset('storage/file/file_projek/1697019909.png') }}"
                                                                    class="text-body text-truncate d-block">{{
                                                                    $item->file_upload}}</a></h5>
                                                            <div></div>
                                                        </div>
                                                        @endforeach --}}
                                ...
                                <div data-simplebar style="height: 235px;" class="mx-n3 px-3">
                                    <div class="vstack gap-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h5 class="fs-13 mb-0"><a href="#" class="text-body d-block">{{
                                                        $data->nm_anggota }} - {{ $data->posisi }} {{ $data->divisi }}</a></h5>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h5 class="fs-13 mb-0"><a href="#" class="text-body d-block">{{
                                                        $data->nm_anggota }} - Man. {{ $data->divisi }}</a></h5>
                                                </p>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <div class="d-flex align-items-center gap-1">
                            ...
                            <div class="row align-items-center team-row">
                                ...
                                <div class="col-lg-4 col">
                                    <div class="team-profile-img">
                                        <div class="team-content">
                                            <a href="#" class="d-block">
                                                <h5 class="fs-16 mb-1">{{ $data->nm_anggota }} - {{$data->posisi}} {{$data->divisi}}</h5>
                                            </a>
                                        </div>
                                    </div>
                                </div>
