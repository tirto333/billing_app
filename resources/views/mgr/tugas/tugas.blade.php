                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="nm_pelanggan">
                                <a href="{{ route('detail.tugas.mgr', ['id' => $data->id]) }}"
...
<div class="modal fade zoomIn" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0">
            ...
            <form action="{{ route ('simpan.tugasmgr') }}" method="POST" autocomplete="off">
                @csrf
                <div class="modal-body">
                    <input type="hidden" id="tasksId" />
                    <div class="row g-3">
                        <div class="col-lg-6">
                            <label for="projek_tugas" class="form-label">Projek</label>
                            <select class="form-select" id="projek_tugas" name="projek_tugas" data-choices
                                ...
                                @foreach ($sjProjek as $data)
                                <option>{{ $data->judul_projek }}
                                </option>
                                <option>{{ $data->no_spk }}
                                </option>
                                @endforeach
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        selectElement.addEventListener("change", function() {
            ...
            // You can now use the selectedData array to access user_name, posisi, and divisi of selected options.
        });
    });
</script>
