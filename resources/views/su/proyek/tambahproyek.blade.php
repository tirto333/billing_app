...
<form action="{{ route('simpan.proyek') }}" enctype="multipart/form-data" method="POST" autocomplete="off">
    @csrf
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="kepala_projek" name="kepala_projek[]" data-choices
                            ...
                            <option value="{{ $data->user_name }} - {{ $data->posisi }} - {{ $data->divisi }}">{{ $data->user_name }} - {{ $data->posisi }}
                                {{$data->divisi}}
                            </option>
                            @endforeach
                        </select>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        selectElement.addEventListener("change", function() {
            ...
            selectedData.length = 0; // Clear the array
