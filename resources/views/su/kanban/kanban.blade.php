...
@section('css')
<link href="{{ URL::asset('build/su/libs/dragula/dragula.min.css') }}" rel="stylesheet">
@endsection
@section('content')
            ...
            <div class="col-lg-auto">
                <div class="hstack gap-2">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createboardModal"><i
                            class="ri-add-line align-bottom me-1"></i> Buat Board</button>
                </div>
            </div>
...
<div class="tasks-board mb-3" id="kanbanboard">
    <div class="tasks-list">
        <div class="d-flex mb-3">
            <div class="flex-grow-1">
                <h6 class="fs-14 text-uppercase fw-semibold mb-0">Belum Ditetapkan <small
                        class="badge bg-success align-bottom ms-1 totaltask-badge">0</small></h6>
            </div>
            <div class="flex-shrink-0">
                <div class="dropdown card-header-dropdown">
                    <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                        <span class="fw-medium text-muted fs-12">Prioritas<i
                                class="mdi mdi-chevron-down ms-1"></i></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end">
                        <a class="dropdown-item" href="#">Prioritas</a>
                        <a class="dropdown-item" href="#">Tanggal Ditambahkan</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex mb-2">
                            <h6 class="fs-15 mb-0 flex-grow-1 text-truncate task-title"><a href="apps-tasks-details"
                                    class="d-block">Struktur Halaman Profil</a></h6>
                            <div class="dropdown">
                        ...
                        <p class="text-muted">Halaman Profil berarti halaman web yang dapat diakses oleh umum atau
                            kepada tamu.</p>
                        <div class="mb-3">
        ...
        <div class="my-3">
            <button class="btn btn-soft-info w-100" data-bs-toggle="modal"
                data-bs-target="#creatertaskModal">Tambah</button>
        </div>
    </div>
    <div class="tasks-list">
        <div class="d-flex mb-3">
            <div class="flex-grow-1">
                <h6 class="fs-14 text-uppercase fw-semibold mb-0">To Do <small
                        class="badge bg-secondary align-bottom ms-1 totaltask-badge">0</small></h6>
            </div>
            <div class="flex-shrink-0">
                <div class="dropdown card-header-dropdown">
                    <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true"
    ...
    <div class="tasks-list">
        <div class="d-flex mb-3">
            <div class="flex-grow-1">
                <h6 class="fs-14 text-uppercase fw-semibold mb-0">Berlangsung <small
                        class="badge bg-warning align-bottom ms-1 totaltask-badge">0</small></h6>
            </div>
            <div class="flex-shrink-0">
                <div class="dropdown card-header-dropdown">
                    <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true"
            ...
            <div id="inprogress-task" class="tasks">
                ...
                <div class="card tasks-box">
                    <div class="card-body">
                        ...
                        <h6 class="fs-15 text-truncate task-title"><a href="apps-tasks-details" class="d-block">Change
                                Old
                                App Icon</a></h6>
    ...
    <div class="tasks-list">
        <div class="d-flex mb-3">
            <div class="flex-grow-1">
                <h6 class="fs-14 text-uppercase fw-semibold mb-0">Dalam Ulasan <small
                        class="badge bg-info align-bottom ms-1 totaltask-badge">0</small></h6>
            </div>
            <div class="flex-shrink-0">
                <div class="dropdown card-header-dropdown">
                    <a class="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true"
    ...
    <div class="tasks-list">
        <div class="d-flex mb-3">
            <div class="flex-grow-1">
                <h6 class="fs-14 text-uppercase fw-semibold mb-0">Selesai <small
                        class="badge bg-success align-bottom ms-1 totaltask-badge">0</small></h6>
            </div>
            <div class="flex-shrink-0">
                <div class="dropdown card-header-dropdown">
    ...
    <div class="tasks-list">
        <div class="d-flex mb-3">
            <div class="flex-grow-1">
                <h6 class="fs-14 text-uppercase fw-semibold mb-0">Baru <small
                        class="badge bg-success align-bottom ms-1 totaltask-badge">0</small></h6>
            </div>
            <div class="flex-shrink-0">
                <div class="dropdown card-header-dropdown">
        ...
        <div class="modal-content border-0">
            ...
            <div class="modal-body">
                <form>
                    <div class="row g-3">
                        <div class="col-lg-12">
                            <label for="submissionidInput" class="form-label">ID Anggota</label>
                            <input type="number" class="form-control" id="submissionidInput"
                                placeholder="No ID Anggota">
                        </div>
                        <div class="col-lg-12">
                            <label for="profileimgInput" class="form-label">Foto Profil</label>
                            <input class="form-control" type="file" id="profileimgInput">
                        </div>
                        <div class="col-lg-6">
                            <label for="firstnameInput" class="form-label">Nama Depan</label>
                            <input type="text" class="form-control" id="firstnameInput" placeholder="Masukan Nama Depan">
                        </div>
                        <div class="col-lg-6">
                            <label for="lastnameInput" class="form-label">Nama Belakang</label>
                            <input type="text" class="form-control" id="lastnameInput" placeholder="Masukan Nama Belakang">
                        </div>
                        <div class="col-lg-12">
                            <label for="designationInput" class="form-label">Penunjukan</label>
                            <input type="text" class="form-control" id="designationInput" placeholder="Penunjukan">
                        </div>
                        <div class="col-lg-12">
                            <label for="titleInput" class="form-label">Judul</label>
                            <input type="text" class="form-control" id="titleInput" placeholder="Judul">
                        </div>
                        <div class="col-lg-6">
                            <label for="numberInput" class="form-label">Nomor Telepon</label>
                            <input type="text" class="form-control" id="numberInput" placeholder="Nomor Telepon">
                        </div>
                        <div class="col-lg-6">
                            <label for="joiningdateInput" class="form-label">Tanggal Gabung</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-bs-dismiss="modal"><i
                        class="ri-close-line align-bottom me-1"></i> Keluar</button>
                <button type="button" class="btn btn-success" id="addMember">Tambah Anggota</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            <div class="modal-header p-3 bg-info-subtle">
                <h5 class="modal-title" id="createboardModalLabel">Tambah Board</h5>
            ...
            <div class="modal-body">
                <form action="#">
                    <div class="row">
                        <div class="col-lg-12">
                            <label for="boardName" class="form-label">Nama Board</label>
                            <input type="text" class="form-control" id="boardName" placeholder="Enter board name">
                        </div>
                        <div class="mt-4">
                            <div class="hstack gap-2 justify-content-end">
                                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Keluar</button>
                                <button type="button" class="btn btn-success" id="addNewBoard">Tambah Board</button>
                            </div>
                        </div>
                    </div>
                </form>
...
<div class="modal fade" id="creatertaskModal" tabindex="-1" aria-labelledby="creatertaskModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0">
            <div class="modal-header p-3 bg-info-subtle">
                <h5 class="modal-title" id="creatertaskModalLabel">Buat Tugas Baru</h5>
            ...
            <div class="modal-body">
                <form action="#">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-12">
                            <label for="sub-tasks" class="form-label">Judul Tugas</label>
                            <input type="text" class="form-control" id="sub-tasks" placeholder="Task title">
                        </div>
                        <div class="col-lg-12">
                            <label for="task-description" class="form-label">Deksripsi Tugas</label>
                            <textarea class="form-control" id="task-description" rows="3"
                                placeholder="Task description"></textarea>
                        </div>
                        <div class="col-lg-12">
                            <label for="formFile" class="form-label">Foto Tugas</label>
                            <input class="form-control" type="file" id="formFile">
                        </div>
                        <div class="col-lg-12">
                            <label for="tasks-progress" class="form-label">Tambah Anggota</label>
                        ...
                        <div class="col-lg-4">
                            <label for="due-date" class="form-label">Tenggat Waktu</label>
                            <input type="text" class="form-control" id="due-date" data-provider="flatpickr"
                                placeholder="Select date">
                        </div>
                        <div class="col-lg-4">
                            <label for="categories" class="form-label">Tag</label>
                            <input type="text" class="form-control" id="categories" placeholder="Enter tag">
                        </div>
                        <div class="col-lg-4">
                            <label for="tasks-progress" class="form-label">Pekembangan Tugas</label>
                        ...
                        <div class="mt-4">
                            <div class="hstack gap-2 justify-content-end">
                                <button type="button" class="btn btn-light" data-bs-dismiss="modal">Keluar</button>
                                <button type="button" class="btn btn-success">Tambah Tugas</button>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-body">
                <div class="mt-2 text-center">
                    ...
                    <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                        <h4>Anda yakin ?</h4>
                        <p class="text-muted mx-4 mb-0">Anda yakin, ingin menghapus tugas ini ?
                        </p>
                    </div>
                </div>
                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                    <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Keluar</button>
                    <button type="button" class="btn w-sm btn-danger" id="delete-record">Ya, Hapus ini!</button>
                </div>
            </div>
        </div>
    </div>
...
@endsection
@section('script')
<script src="{{ URL::asset('build/su/libs/dragula/dragula.min.js') }}"></script>
<script src="{{ URL::asset('build/su/libs/dom-autoscroller/dom-autoscroller.min.js') }}"></script>
<script src="{{ URL::asset('build/su/js/pages/tasks-kanban.init.js') }}"></script>
