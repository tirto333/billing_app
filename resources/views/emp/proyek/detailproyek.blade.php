                        ...
                        <div class="col-md">
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col-md">
                                    ...
                                    <div>
                                        <h4 class="fw-bold">{{ $data->judul_projek}}{{ $data->no_spk }}</h4>
...
<div class="row">
                            ...
                            <div class="card-body">
                                <div data-simplebar style="height: 235px;" class="mx-n3 px-3">
                                    <div class="vstack gap-3">
                                        ...
                                        @endforeach
                                        @foreach ($dataAnggotaProjek as $data)
                                        <div class="d-flex align-items-center">
                                            <div class="flex-grow-1">
                                                <h5 class="fs-13 mb-0"><a href="#" class="text-body d-block">
                                                        {{ $data->nm_anggota }} - </br>Staff {{ $data->divisi }}</a>
                                                </h5>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <div class="d-flex align-items-center gap-1">
    ...
    var avatarGroups = document.querySelectorAll('.avatar-group');
    avatarGroups.forEach(function(avatarGroup) {
        var randomColor = getRandomColor();
        avatarGroup.querySelector('.avatar-title').style.backgroundColor = randomColor;

        var text = avatarGroup.querySelector('.avatar-title').textContent.trim();
        var words = text.split(' ');
        var secondChars = words.map(function(word) {
            if (word.length > 1) {
                return word.charAt(0).toUpperCase();
            }
            return "";
        });
        var initials = secondChars.join('');
        avatarGroup.querySelector('.avatar-title').textContent = initials;
    });
    </script>
