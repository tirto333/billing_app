...
function editEvent(data) {
    ...
    if (data_id == 'new-event') {
        document.getElementById('modal-title').innerHTML = "";
        document.getElementById('modal-title').innerHTML = "Tambah Agenda";
        document.getElementById("btn-save-event").innerHTML = "Tambah Agenda";
        eventTyped();
    } else if (data_id == 'edit-event') {
        data.innerHTML = "Batal";
        data.setAttribute("data-id", 'cancel-event');
        document.getElementById("btn-save-event").innerHTML = "Perbaharui Agenda";
